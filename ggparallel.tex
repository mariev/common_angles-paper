...
However, the parallel sets plot suffers from the line width illusion, that can in extreme cases be so severe as to lead the user to wrong conclusions about the displayed data.  Section \ref{survey1} will show more details on the strength of this illusion.


\subsection{Strength of the Linewidth Illusion}\label{survey1}
\begin{figure}[hbtp]
\centering
...
In a first survey, we asked participants to rank class  levels according to the number of survivors (from highest to lowest) based on one of the two plots in figures \ref{question1a} and \ref{question1b}. The actual number of survivors by class are
%
\begin{center}
\begin{tabular}{rrrrr}
...
As previously, ribbons are drawn between categories, whose widths  are proportional to  the number of records they represent.
...
All surveys for this study were carried out under approval from  IRB-ID 12-204.
