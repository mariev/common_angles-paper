...
\caption{\label{tit-hierarchy} Common angle plot of the Titanic data using a hierarchical structure in the variable (cf. to parallel sets chart at \url{http://www.jasondavies.com/parallel-sets/}). }
\end{figure}
