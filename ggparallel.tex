...
parllel sets and the reverse in hammock plots. By giving up on the paradigm of straight lines for drawing connections between levels in the common angle plot, we are able to circumnavigate both illusions, and present an illusion-free alternative that encodes the same information as the widely used parallel sets  or the hammock plots.
