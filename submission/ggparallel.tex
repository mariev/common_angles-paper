...
A very recent example of related work can be found in \citep{bostock:2012}; the chart is an interactive d3 display that shows political shifts of states and corresponding electoral votes in a combination  of  parallel coordinates of state-based votes overlaid by a Sankey-type plot to connect states across past elections.
