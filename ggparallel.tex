...
\begin{figure*}[htbp]
\begin{center}
\includegraphics[height=1.6in]{images/aspect31-titanic.pdf}
\includegraphics[height=1.6in]{images/aspect33-titanic.pdf}
\end{center}
