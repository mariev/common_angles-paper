...
\begin{abstract}
Graphics are tools of communication: the purpose of a good chart is to summarize quantitative information and present it in a way that enables readers to extract the main message easily and with a minimum of distortion. 
Perceptual limitations of our audience are another source of distortions.
We discuss the effect and strength of the line-width illusion on designs related to displaying associations between categorical variables.
Parallel coordinate plots were introduced to visualize large numbers of numeric variables.
We will first show how the line-width illusion affects parallel coordinate plots for categorical data, and in a second step introduce the common-angle plot as an alternative method for displaying categorical data in a manner that minimizes the effect from perceptual illusions.
...
\begin{keywords}
Linewidth illusion, Data Visualization, High-dimensional Displays, Parallel Sets, Hammock Plots
\end{keywords}}
